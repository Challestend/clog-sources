...
~~个人认为~~珂朵莉树的另一大优势就是实现难度简单~~，毕竟那么暴力~~，就算您刚学，您也有可能一遍写对然后交上去一遍切。

一般来讲，这篇blog写到这里就可以贴上珂朵莉树的完整板子然后结束了。不过……

> 手里拿着锤子看什么都是钉子。

之前那位珂学家为了练习珂朵莉树甚至不惜翻出了[「NOIp2005PJT2」校门外的树](https://www.luogu.org/problemnew/show/P1047)，并用线段树、分块、珂朵莉树等多种数据结构花式切掉了这题。
...
> 
> ——为何要用珂朵莉树？只是为了炫耀你们的学识吗？是的。

以上改编自之前那位珂学家的blog以及下面的评论~~，我也跟着复读了一句~~。
